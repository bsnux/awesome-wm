...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "terminal", "browser", "code", "xcat", "5", "6" }, s, awful.layout.layouts[1])
...
awful.spawn.with_shell("/home/afernandez/scripts/swapcaps.sh")
awful.spawn("xrandr -s 1600x900")
